...
namespace Voto_Electronico
{
    public partial class FrmCiudadanos : Form
    {
        ...
        public FrmCiudadanos()
        {
            ...
            InitializeComponent();
            AD = new AccesoDatos(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Ismas\Desktop\Voto Electronico\VotoElectronico V2.mdb");
            AD2 = new AccesoDatos(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Ismas\Desktop\Voto Electronico\VotoElectronico V2.mdb");
        }
        ...
        private void btnAgregarCiudadano_Click(object sender, EventArgs e)
        {
            ...
            btnConfirmarModif.Enabled = true;
        }
