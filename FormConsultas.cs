...
namespace Voto_Electronico
{
    public partial class FrmConsultas : Form
    {
        ...
        {
            Deshabilitar1(false); 
            d = new AccesoDatos(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\Ismas\Desktop\Voto Electronico\VotoElectronico V2.mdb");
        }
        ...
        private void btnConsulta3_Click_1(object sender, EventArgs e)
        {
            ...
            + " WHERE v.id_mesa = m.id_mesa and e.id_escuela = m.id_escuela and e.id_depto = d.id_depto and id_candidato = 12 and d.Nomdpto like 'capital'");
        }
        ...
        private void btnConsulta5_Click_1(object sender, EventArgs e)
        {
            ...
            d.cargardatagrid(dgvConsultas, "SELECT m.id_mesa as 'Numero de Mesa', e.NombEscuela as 'Nombre de la Escuela', b.NomBarrio as 'Nombre del Barrio', el.descripcion as 'Tipo de Elecciones'"
                + "FROM Escuelas e, Mesas m, Elecciones el, Barrios b WHERE m.id_escuela = e.Id_escuela and e.id_barrio = b.id_barrio and m.id_eleccion = el.id_eleccion and b.nom_barrio like 'Alberto' and el.descripcion like 'Senador'");
        }
